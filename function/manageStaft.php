...
<head>
    ...
    <script>
        ...
        function create_edt_modal(args) {
            ...
            xmlhttp.open("GET", "./create_edt_modal.php?edit_staff&username=" + args, true);
            xmlhttp.send();
        }
        ...
        function loadData(){
            ...
            if (window.XMLHttpRequest) {
                ...
                xmlhttp.open("GET", "./searchController.php?staff&search="+search, true);
                xmlhttp.send();
        }
    </script>
...
<body>
    ...
    <div class="fullscreen">
        ...
        <div class="center" style="width: 78%;">
            ...
            <div class="row">
                <div class="col-2">
                    <button type="button" class="btn btn-primary btn_format" style="background-color: #3476ae; border:0px;box-shadow: #b9b8b8 5px 5px 10px;margin-left:25%" data-toggle="modal" data-target="#exampleModalCenter">เพิ่มพนักงาน</button>
                </div>

                <div class="col-10">
                    <input onkeyup="loadData()" style="width: 50%;" type="text" name="search" id="search" class="form-control" placeholder="ค้นหาข้อมูลพนักงาน">
                </div>
            </div>
                ...
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="./staffController.php?insert" method="post" enctype="multipart/form-data">
